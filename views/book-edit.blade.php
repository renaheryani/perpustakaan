        ...
        <div class="container ">
            <form action="/book-edit/{{ $book->slug }}" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="book_code" id="book_code" class="form-control" placeholder="masukan kode buku" value="{{ $book->book_code }}">
                </div>
                <br>
                <div class="form-group">
                    <label for="title" class="form-label">Judul Buku</label>
                    <input type="text" name="title" id="title" class="form-control" placeholder="masukan judul buku" value="{{ $book->title }}">
                </div>
                <br>
                <div class="form-group">
                ...
                <div class="form-group">
                    <label for="currentImage" class="form-label" style="display: block">Gambar Sebelumnya</label>
                        ...
                        @else
                            <img src="{{ asset('images/notfound.jpg'.$book->cover) }}" alt="" width="150px">
                        @endif
                    
                </div>
                <br>
                <div class="form-group">
                    <label for="currentCategory" class="form-label">Kategori Buku</label>
                ...
                <br>
                <div class="form-group">
                    <label for="title" class="form-label">Kategori Sebelumnya</label>
                    <ul>
